...
pattern.
``Mode'' means the MPI file access mode when open the file. We tested all the
combinations and we encounter errors either from HDFS side or MPI side. According to the
